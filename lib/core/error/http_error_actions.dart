...
class HttpErrorActions {
  HttpErrorActions({
    ...
    if (_statusCode != null && HTTPStatusCodeEnum(_statusCode).isClientError()
      ...
      switch (errorType) {
        case FunctionsErrorType.getPlaces:
          break;

        case FunctionsErrorType.getCurrentWeatherDetails:
          break;

        case FunctionsErrorType.getForecastWeatherDetails:
          break;
    ...
    // decide on Server errors
      ...
      throw ServerException(
        ...
        exception: exception,
        fieldErrors: null,
        nonFieldError: exception.response?.data.toString(),
        uiVisible: false,
      );
    }
